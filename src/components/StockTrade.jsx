    ...
    <div className="p-8 max-w-5xl mx-auto bg-gray-900 rounded-xl shadow-lg">
      ...
      <div className="flex justify-between items-center bg-gray-800 p-4 rounded-lg mb-6">
        <p className="text-lg text-gray-300">
          ...
          <span
            className={
              price > averagePrice ? "text-blue-400" : "text-yellow-500"
            }
          >
            ${price}
          </span>
        ...
        <p className="text-lg text-gray-300 flex items-center">
          ...
          <span className="ml-2 text-xl">{shares}</span>
        </p>
      </div>
      ...
      <div className="flex justify-center space-x-4">
        <button
          ...
          className="px-6 py-2 bg-transparent border-2 border-blue-500 hover:bg-blue-500 text-white font-bold rounded-lg shadow-lg transition duration-300"
        >
          Comprar Todo
        </button>
        <button
          onClick={handleSellAll}
          className="px-6 py-2 bg-transparent border-2 border-yellow-500 hover:bg-yellow-500 text-white font-bold rounded-lg shadow-lg transition duration-300"
        >
          Vender Todo
        </button>
      </div>
